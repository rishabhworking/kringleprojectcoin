...
# Script to issue assets on the Kringleprojectcoin platform
...
# Prerequisite: kringleprojectcoind daemon to be running
...
#Set this to your kringleprojectcoin-cli program
cli = "kringleprojectcoin-cli"

mode =  "-testnet"
rpc_port = 18501
#mode =  "-regtest"
#rpc_port = 18443
csv_file = "KringleProjectCoin Assets - Sheet1.csv"
#Set this information in your kringleprojectcoin.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
