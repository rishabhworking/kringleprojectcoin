...
class DecodeScriptTest(KringleProjectCoinTestFramework):
    ...
    def decodescript_assets(self):
        """Test decoding KPC_ASSETS scripts (regtest scripts)."""
        ...
        assert_equal('OP_DUP OP_HASH160 35a8d9b395f1594e2cf3e06e6ec357d1da897368 OP_EQUALVERIFY OP_CHECKSIG OP_KPC_ASSET 72766e710954455354415353455400e40b540200000008000000 OP_DROP', result['asm'])
