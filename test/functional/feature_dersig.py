...
class BIP66Test(KringleProjectCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # kringleprojectcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and kringleprojectcoind produces more specific reject
            # reasons.
