...
# TestNode: A peer we use to send messages to kringleprojectcoind, and store responses.
...
class CompactBlocksTest(KringleProjectCoinTestFramework):
    ...
    # This test actually causes kringleprojectcoind to (reasonably!) disconnect us, so do this last.
    ...
    # kringleprojectcoind's choice of nonce.
    ...
    # Test that kringleprojectcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for kringleprojectcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # kringleprojectcoind will not send blocktxn responses for blocks whose height is
