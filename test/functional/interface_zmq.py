...
from test_framework.test_framework import KringleProjectCoinTestFramework, SkipTest
...
class ZMQTest (KringleProjectCoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that kringleprojectcoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("kringleprojectcoind has not been built with zmq enabled.")
