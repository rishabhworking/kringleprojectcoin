...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KringleProjectCoinTestFramework
    pass

class ExampleTest(KringleProjectCoinTestFramework):
    # Each functional test is a subclass of the KringleProjectCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        KringleProjectCoinTestFramework class so other tests can use it."""
