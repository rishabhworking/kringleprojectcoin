...
By default, kringleprojectcoind will dump mempool on shutdown and
...
class MempoolPersistTest(KringleProjectCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give kringleprojectcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent kringleprojectcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
