...
class TxnMallTest(KringleProjectCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 KPC:
        ...
        # First: use raw transaction API to send 1240 KPC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 KPC coin each
        ...
        # Node0's balance should be starting balance, plus 50KPC for another
        ...
        # Node0's total balance should be starting balance, plus 100KPC for 
