...
DISTNAME=kringleprojectcoin-2.0.3
MAKEOPTS="-j4"
BRANCH=master
clear
if [[ $EUID -ne 0 ]]; then
...
rm -rf ~/kringleprojectcoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../kringleprojectcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../kringleprojectcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/kringleprojectcoin/temp
cd ~/kringleprojectcoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/kringleprojectcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/kringleprojectcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
