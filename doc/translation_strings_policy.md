...
This document provides guidelines for internationalization of the KringleProjectCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kringleprojectcoin_en.ts` remains unchanged.
