...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kringleprojectcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kringleprojectcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kringleprojectcoin transaction") + "\n" +
              "  kringleprojectcoin-tx [options] -create [commands]   " + _("Create hex-encoded kringleprojectcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kringleprojectcoin transaction
