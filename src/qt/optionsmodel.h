...
#ifndef KPC_QT_OPTIONSMODEL_H
#define KPC_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for KringleProjectCoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // KringleProjectCoinUnits::Unit
