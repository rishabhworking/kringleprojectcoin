...
#ifndef KPC_QT_GUIUTIL_H
#define KPC_QT_GUIUTIL_H
...
/** Utility functions used by the KringleProjectCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kringleprojectcoin:" URI into recipient object, return true on successful parsing
