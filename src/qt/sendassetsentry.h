...
#ifndef KPC_QT_SENDASSETSENTRY_H
#define KPC_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending kringleprojectcoins.
...
#endif // KPC_QT_SENDASSETSENTRY_H
