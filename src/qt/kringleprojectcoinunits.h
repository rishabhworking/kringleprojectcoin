...
#ifndef KPC_QT_KPCUNITS_H
#define KPC_QT_KPCUNITS_H
...
/** KringleProjectCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KringleProjectCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KringleProjectCoinUnits(QObject *parent);

    /** KringleProjectCoin units.
      @note Source: https://en.kringleprojectcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KPC,
...
typedef KringleProjectCoinUnits::Unit KringleProjectCoinUnit;

#endif // KPC_QT_KPCUNITS_H
