...
#ifndef KPC_QT_RECEIVECOINSDIALOG_H
#define KPC_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of kringleprojectcoins */
...
#endif // KPC_QT_RECEIVECOINSDIALOG_H
