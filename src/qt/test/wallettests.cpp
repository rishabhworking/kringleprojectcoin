...
#include "qt/kringleprojectcoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<KringleProjectCoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_kringleprojectcoin-qt -platform xcb      # Linux
//     src/qt/test/test_kringleprojectcoin-qt -platform windows  # Windows
//     src/qt/test/test_kringleprojectcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = KringleProjectCoinUnits::formatWithUnit(unit, balance, false, KringleProjectCoinUnits::separatorAlways);
    ...
    // Amount input
    KringleProjectCoinAmountField* amountInput = receiveCoinsDialog.findChild<KringleProjectCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: kringleprojectcoin:")) != -1);
