...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(KringleProjectCoinUnits::KPC),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(KringleProjectCoinUnits::formatWithUnit(unit, balance, false, KringleProjectCoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(KringleProjectCoinUnits::formatWithUnit(unit, unconfirmedBalance, false, KringleProjectCoinUnits::separatorAlways));
    ui->labelImmature->setText(KringleProjectCoinUnits::formatWithUnit(unit, immatureBalance, false, KringleProjectCoinUnits::separatorAlways));
    ui->labelTotal->setText(KringleProjectCoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, KringleProjectCoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(KringleProjectCoinUnits::formatWithUnit(unit, watchOnlyBalance, false, KringleProjectCoinUnits::separatorAlways));
    ui->labelWatchPending->setText(KringleProjectCoinUnits::formatWithUnit(unit, watchUnconfBalance, false, KringleProjectCoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(KringleProjectCoinUnits::formatWithUnit(unit, watchImmatureBalance, false, KringleProjectCoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(KringleProjectCoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, KringleProjectCoinUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the KPC balance grid from expanding and looking terrible when asset balance is hidden
