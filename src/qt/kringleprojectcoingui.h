...
#ifndef KPC_QT_KPCGUI_H
#define KPC_QT_KPCGUI_H
...
/**
  KringleProjectCoin GUI main class. This class represents the main window of the KringleProjectCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KringleProjectCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KringleProjectCoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~KringleProjectCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a kringleprojectcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
