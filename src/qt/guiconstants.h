...
#ifndef KPC_QT_GUICONSTANTS_H
#define KPC_QT_GUICONSTANTS_H
...
/* KringleProjectCoinGUI -- Size of icons in status bar */
...
/* Kringleprojectcoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05339")
/* Kringleprojectcoin light orange */
#define COLOR_LIGHT_ORANGE QColor("#f79433")
/* Kringleprojectcoin dark blue */
#define COLOR_DARK_BLUE QColor("#475eaa")
/* Kringleprojectcoin light blue */
#define COLOR_LIGHT_BLUE QColor("#5874cf")
/* Kringleprojectcoin asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* Kringleprojectcoin shadow color - light mode */
...
/* Kringleprojectcoin shadow color - dark mode */
#define COLOR_SHADOW_DARK QColor("#0c1b3d")
/* Kringleprojectcoin Light blue - dark mode - dark mode */
#define COLOR_LIGHT_BLUE_DARK QColor("#1e2636")
/* Kringleprojectcoin Dark blue - dark mode - dark mode */
#define COLOR_DARK_BLUE_DARK QColor("#0b1018")
/* Pricing widget background color */
#define COLOR_PRICING_WIDGET QColor("#161e2d")
/* Kringleprojectcoin dark mode administrator background color */
#define COLOR_ADMIN_CARD_DARK COLOR_BLACK
/* Kringleprojectcoin dark mode regular asset background color */
...
/* Kringleprojectcoin label color as a string */
...
#define QAPP_ORG_NAME "KringleProjectCoin"
#define QAPP_ORG_DOMAIN "kringleprojectcoin.org"
#define QAPP_APP_NAME_DEFAULT "KringleProjectCoin-Qt"
#define QAPP_APP_NAME_TESTNET "KringleProjectCoin-Qt-testnet"

#endif // KPC_QT_GUICONSTANTS_H
