...
{
    columns[Amount] = KringleProjectCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed, KringleProjectCoinUnits::SeparatorStyle separators) const
{
    QString str;
    switch(wtx->type) {
        case TransactionRecord::Issue:
        ...
        default:
            {
            str = KringleProjectCoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit,
                                             false, separators);
            } break;
    }
    if (showUnconfirmed) {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, KringleProjectCoinUnits::separatorAlways);
        case AssetName:
            return QString::fromStdString(rec->assetName);
        }
        break;
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, KringleProjectCoinUnits::separatorNever));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, KringleProjectCoinUnits::separatorNever);
    case AssetNameRole:
        {
            QString assetName;
...
QVariant TransactionTableModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if(orientation == Qt::Horizontal)
    {
        ...
        } else if (role == Qt::ToolTipRole)
        {
            ...
            case AssetName:
                return tr("The asset (or KPC) removed or added to balance.");
            }
        }
    }
    return QVariant();
