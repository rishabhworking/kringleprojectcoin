...
#include "test_kringleprojectcoin.h"
...
TestingSetup::TestingSetup(const std::string &chainName) : BasicTestingSetup(chainName)
{
    ...
    ClearDatadirCache();
    pathTemp = fs::temp_directory_path() / strprintf("test_kringleprojectcoin_%lu_%i", (unsigned long) GetTime(), (int) (InsecureRandRange(100000)));
