...
BOOST_FIXTURE_TEST_SUITE(netbase_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
    {
        ...
        BOOST_CHECK(TestSplitHost("www.kringleprojectcoin.org", "www.kringleprojectcoin.org", -1));
        BOOST_CHECK(TestSplitHost("[www.kringleprojectcoin.org]", "www.kringleprojectcoin.org", -1));
        BOOST_CHECK(TestSplitHost("www.kringleprojectcoin.org:80", "www.kringleprojectcoin.org", 80));
        BOOST_CHECK(TestSplitHost("[www.kringleprojectcoin.org]:80", "www.kringleprojectcoin.org", 80));
