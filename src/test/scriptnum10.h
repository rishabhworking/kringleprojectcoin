...
#ifndef KPC_TEST_SCRIPTNUM10_H
#define KPC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from KringleProjectCoin Core 0.10.0, for cross-comparison.
 */
public:
