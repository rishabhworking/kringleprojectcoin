...
{
    RenameThread("kringleprojectcoin-http");
...
{
    RenameThread("kringleprojectcoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/KringleProjectCoinProject/Kringleprojectcoin/pull/6990)
